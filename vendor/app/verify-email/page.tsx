      ...
      <div className="max-w-md w-full bg-white p-12 md:p-16 rounded-[3rem] shadow-2xl border border-[#eb9a05]/10 relative z-10 text-center animate-fade-in-up">
        ...
        {isLoading ? (
          ...
          <div className="py-10 space-y-8 animate-fade-in-up">
            ...
            <Link href="/login" className="btn-primary w-full py-5 rounded-2xl flex items-center justify-center gap-4 group">
          ...
          <div className="py-10 space-y-8 animate-fade-in-up">
            ...
            <div className="space-y-4">
              <Link href="/login" className="btn-primary w-full py-5 rounded-2xl flex items-center justify-center gap-4">
              ...
              <p className="text-[10px] font-black tracking-widest uppercase text-gray-300">
                If the link expired, <Link href="/login" className="text-[#eb9a05] hover:underline">re-authenticate</Link>
              </p>
            </div>
          </div>
        )}
