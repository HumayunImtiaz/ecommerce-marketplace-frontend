      ...
      <div className="max-w-md w-full bg-white p-12 md:p-16 rounded-[3rem] shadow-2xl border border-[#eb9a05]/10 relative z-10 animate-fade-in-up">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-400 text-xs font-bold tracking-widest uppercase mt-4">
            New to LuxaCart?{" "}
            <Link href="/register" className="text-[#eb9a05] hover:underline">
              Create Account
            </Link>
          </p>
        </div>
        ...
        <div className="space-y-8">
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between px-4">
              ...
              <Link href="/forgot-password" className="text-[10px] font-black tracking-widest uppercase text-[#eb9a05] hover:underline">
                Forgot Password?
              </Link>
            </div>
            <div className="relative">
          ...
          <div className="flex justify-center">
            <div className="w-full transform hover:scale-105 transition-transform duration-500">
              <GoogleOAuthProvider clientId={process.env.NEXT_PUBLIC_GOOGLE_CLIENT_ID || "648738872309-d0q3u06kndnq3d26kc6mfd6qu262ggl8.apps.googleusercontent.com"}>
                <GoogleLogin
